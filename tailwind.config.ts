  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "ticker-tick": { "0%": { transform: "translateY(100%)" }, "100%": { transform: "translateY(0)" } },
      },
      animation: {
        "accordion-down": "accordion-down 0.2s ease-out",
        "accordion-up": "accordion-up 0.2s ease-out",
        "fade-in": "fade-in 0.8s cubic-bezier(0.7,0,0.2,1) forwards",
        "slide-in-left": "slide-in-left 0.9s cubic-bezier(0.7,0,0.2,1) forwards",
        "slide-in-right": "slide-in-right 0.9s cubic-bezier(0.7,0,0.2,1) forwards",
        "scale-in": "scale-in 0.6s cubic-bezier(0.7,0,0.2,1) forwards",
        "ticker": "ticker-tick 0.6s cubic-bezier(0.85,0,0.15,1) forwards",
      },
    },
  },
